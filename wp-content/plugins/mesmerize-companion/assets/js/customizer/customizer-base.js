                        ...
                        var options = {
                            ...
                            setup: function (ed) {
                                ...
                                ed.addButton('alignment', {
                                    ...
                                    values: [
                                        {icon: 'alignleft', text: '', value: 'left'},
                                        {icon: 'aligncenter', text: '', value: 'center'},
                                        {icon: 'alignright', text: '', value: 'right'},
                                        {icon: 'alignjustify', text: '', value: 'justify'}
                                    ],
                                    onPostRender: function () {
                                        var btn = this;
                    ...
                    'link':
                        {
                            icon: 'fa-link',
                            data:
                                '<a class="link" data-cpid="new" data-container-editable="true" data-content-code-editable href="#">new link</a>'
                        }
                    ,
                    'button':
                        {
