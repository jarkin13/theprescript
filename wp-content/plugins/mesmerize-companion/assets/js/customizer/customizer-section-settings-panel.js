...
(function (root, CP_Customizer, $) {
    CP_Customizer.addModule(function (CP_Customizer) {
        ...
        sectionPanel.registerArea('background_color', {
            init: function ($container) {
                ...
                CP_Customizer.createControl.infoPRO(
                    ...
                    $container,
                    '<span>More section design options available in PRO</span><br/> ' +
                    '<a href="http://extendthemes.com/mesmerize/" class="button button-small button-orange upgrade-to-pro" target="_blank">Check all PRO features</a>'
                )
            },
            ...
            init: function ($container) {
                ...
                var textAlign = CP_Customizer.createControl.select(
                    ...
                    $container,
                    {
                        ...
                        label: 'Content align',
                        choices: {
                            'content-align-default': 'Default',
                            'content-left-sm': 'Left',
                            'content-center-sm': 'Center',
                            'content-right-sm': 'Right'
                        }
                    });
        ...
        sectionPanel.registerArea('frame', {
            init: function ($container) {
                var frameSeparator = CP_Customizer.createControl.sectionSeparator(this.getPrefixed('separator'), $container, 'Frame Settings');
